...
public final class GStage {
   ...
   private static StageBorder border;
   ...
   public static void init(float width, float height, float camera_offset_x, float camera_offset_y, StageBorder var4) {
      //Mesh.forceVBO = true;
     // if(Gdx.graphics.isGL20Available()) {
      ...
      //stage.getViewport().setScreenY(200);//.getCamera().translate(0, 500, 0);
...
//      Gdx.input.setInputProcessor(stage);
   ...
   public static void registerUpdateService(String var0, GUpdateService var1) {
      if(var1 != null) {
   ...
   private static void updateServices(float var0) {
      if(!pauseUpdateServices) {
         ...
         while(var1.hasNext()) {
            GUpdateService var2 = (GUpdateService)var1.next();
            if(var2.update(var0)) {
